...
infrastructure decisions live in [SUITE.md](https://github.com/KwaminaWhyte/prism-suite/blob/main/SUITE.md) and reuse [Pigment's engine research](https://github.com/KwaminaWhyte/prism-suite/blob/main/RESEARCH.md)
...
(see [Pigment RESEARCH.md §2](https://github.com/KwaminaWhyte/prism-suite/blob/main/RESEARCH.md)). Pulse's addition is a **time axis**: every node
...
Sources: [Pigment RESEARCH.md §2](https://github.com/KwaminaWhyte/prism-suite/blob/main/RESEARCH.md) (tile compositing, blend math, render graph) · w3.org/TR/compositing-1
...
Sources: openfx.readthedocs.io · helpx.adobe.com/after-effects/using/effect-list.html · [Pigment RESEARCH.md §8](https://github.com/KwaminaWhyte/prism-suite/blob/main/RESEARCH.md) (prism-fx, GPU filter passes)
...
Sources: aswf.io (Rust Working Group, OpenEXR Rust binding) · github.com/johannesvollmer/exrs · opencolorio.org · [Pigment RESEARCH.md §3](https://github.com/KwaminaWhyte/prism-suite/blob/main/RESEARCH.md) (exr, color)
...
Sources: [Contour RESEARCH.md §1](https://github.com/KwaminaWhyte/prism-suite/blob/main/RESEARCH.md) (kurbo/lyon/i_overlay) · github.com/pykeio/ort · github.com/ZhengPeng7/BiRefNet · github.com/pop-os/cosmic-text · helpx.adobe.com (masks, shape layers, text animators)
...
Sources: github.com/rayon-rs/rayon · helpx.adobe.com/after-effects (multi-frame rendering, RAM preview, render queue) · [Pigment RESEARCH.md §2](https://github.com/KwaminaWhyte/prism-suite/blob/main/RESEARCH.md) (tile cache LRU / streaming)
...
shared render-graph node model and the `prism-doc` interchange container (see [SUITE.md](https://github.com/KwaminaWhyte/prism-suite/blob/main/SUITE.md)).
...
Sources: [SUITE.md](https://github.com/KwaminaWhyte/prism-suite/blob/main/SUITE.md) (Dynamic Link, smart objects, prism-doc, shared color/assets)
