...
//!
//! This is the GPUI port of `pulse_app::graph::show`: the same coordinate maps,
...
use pulse_app::comp::{Comp, Ease, Handle, Interp, Prop, Track};
...
fn paint(
    ...
    layer: &pulse_app::comp::PulseLayer,
    plotted: &[Prop],
    f: &Frame,
    time: f32,
