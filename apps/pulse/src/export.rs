...
//! UI thread via [`crate::render::export_sequence_in_project`]. The GPUI host
...
mod tests {
    use super::*;
    use crate::comp::Project;
    use crate::render::range_frame_count;
    ...
    fn tiny(project: &mut Project) {
        for c in &mut project.comps {
            ...
            c.work_area = crate::comp::WorkArea::full(c.duration);
        }
    }
    ...
    fn spawn_work_area_writes_only_trimmed_frames() {
        ...
        project.comps[ci].work_area = crate::comp::WorkArea { start: 0.1, end: 0.3 };
