...
//!   `crate::preview::paint_gizmo`.
//!
//! All the drag math is the engine's pure [`crate::gizmo`] module (no fork);
...
use crate::gizmo::{GizmoGeom, Handle as GizmoHandle};
...
/// comp→screen mapping `(center, scale)`. Mirrors `crate::preview::paint_gizmo`:
