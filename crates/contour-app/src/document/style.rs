...
pub struct StrokeStyle {
    ...
    pub arrow_scale: f32,
    /// Width-tool taper: start and end width multipliers (1.0 = full width).
    /// `(1.0, 1.0)` = uniform (default). Additive.
    #[serde(default = "default_width_profile")]
    pub width_profile: (f32, f32),
}

fn default_width_profile() -> (f32, f32) {
    (1.0, 1.0)
}
...
impl Default for StrokeStyle {
    fn default() -> Self {
        Self {
            ...
            width_profile: default_width_profile(),
        }
    }
}
